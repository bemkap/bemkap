...
```{r, echo=FALSE, fig.align='center'}
boxplot(usuarios$edad_usuario,horizontal=T,xlab="Edad",ylim=c(20,80),col="lightblue")
...
box()
mtext("Gráfica 4: Porcentajes de las 10 estaciones de origen de EcoBici\ncon más recorridos en el año 2020",cex=1.1)
```
...
box()
mtext("Gráfica 6: Porcentaje de las 10 estaciones de destino de EcoBici\ncon más recorridos en el año 2020",cex=1.1)
```
...
La mitad de los usuarios anduvo 2022 metros o menos, y el promedio fue de 1998 metros.
\newpage
...
```{r, echo=FALSE, fig.align='center'}
barplot(GGET,ylim=c(0,20),col=c("lightblue","green","orange"),ylab="Cantidad de usuarios",xlab="Edad",beside=T,legend.text=c("Femenino","Masculino","Otro"))
box()
